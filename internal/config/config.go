...
type Config struct {
	...
	DedupSec        int            `json:"dedup_sec" yaml:"dedup_sec"` // 同一关键词最小触发间隔（秒）
...
var DefaultConfig = Config{
	...
	Targets: []TargetApp{
		...
		{Name: "Foxmail", Process: "Foxmail.exe", WindowClass: "TApplication", Enabled: true},
	},
